									...
									<div class="col-lg-6 col-12">
										<div class="product-des">
											...
											<div class="short">
                                                ...
                                                @endphp
												<p class="price"><span class="discount">{{number_format($after_discount,2)}}VND</span>
													...
													@if($product_detail->size)
														<div class="size mt-4">
															...
															@foreach($sizes as $key=>$size)
																<input type="radio" class="btn-check" name="options-outlined" id="danger-outlined-{{$size}}" autocomplete="off">
																<label class="btn btn-outline-danger" style="padding: 5px 15px;" for="danger-outlined-{{$size}}">{{$size}}</label>
															@endforeach
														</div>
                                                    @endif
															...
															<div class="col-12">
																...
																<div class="comment-review">
																	<div class="add-review">
																		<h5>Thêm đánh giá</h5>
																		<p>Vui lòng gửi mail về cho chúng tôi</p>
																	</div>
																...
																<form class="form" method="post" action="{{route('review.store',$product_detail->slug)}}">
                                                                    ...
                                                                    <div class="row">
																		...
																		<?php 
																			$slug = str_replace('http://localhost:8000/product-detail/',"",Request::url());
																			$userLogin = Auth::user();
																			$product = App\Models\Product::where('slug',$slug)->first();
																			$order = App\Models\Cart::where('user_id',$userLogin->id)
																...
																<p class="text-center p-5">
																	Bạn vui lòng đang nhập <a href="{{route('login.form')}}" style="color:rgb(54, 54, 204)">Đăng nhập</a> hoặc <a style="color:blue" href="{{route('register.form')}}">Đăng ký</a>
																...
																<div class="ratting-main">
																	<div class="avg-ratting">
																		...
																		@endphp --}}
																		<h4>{{ceil($product_detail->getReview->avg('rate'))}} <span>(Tổng đánh giá)</span></h4>
																		<span> {{$product_detail->getReview->count()}} bình luận</span>
																	</div>
