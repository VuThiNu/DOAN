                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-12">
                            <div class="checkout-form">
                                ...
                                <p>Vui lòng đăng ký để thanh toán</p>
                                <!-- Form -->
                                <div class="row">
...
{{--                                                <option value="ZW">Zimbabwe</option>--}}
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="address2" placeholder="" value="{{ $total_amount }}">
                                            @error('address2')
                                                <span class='text-danger'>{{$message}}</span>
                                            @enderror
                                        </div>
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="order-details">
                                ...
                                <div class="single-widget">
                                    ...
                                    <div class="content">
                                        <ul>
										    <li class="order_subtotal" data-price="{{Helper::totalCartPrice()}}">Tông tiền trong giỏ hàng<span>{{number_format(Helper::totalCartPrice(),2)}} VND</span></li>
                                            <li class="shipping">
                                                Shipping Cost
                                            ...
                                            @endphp
                                            @if(session('coupon'))
                                                <li class="last"  id="order_total_price">Tổng<span>{{number_format($total_amount,2)}} VND</span></li>
                                            @else
                                                <li class="last"  id="order_total_price">Tổng<span>{{number_format($total_amount,2)}} VND</span></li>
                                            @endif
                                        </ul>
...
{{--    <script src="https://www.paypal.com/sđk/js?client-id={{ env('PAYPAL_CLIENT_ID') }}"></script>--}}
