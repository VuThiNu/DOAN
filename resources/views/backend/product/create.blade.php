...
<div class="card">
    ...
    <div class="card-body">
      <form method="post" action="{{route('product.store')}}">
        ...
        <div class="form-group">
          <label for="summary" class="col-form-label">Bảng tóm tắt <span class="text-danger">*</span></label>
        ...
        <div class="form-group">
          <label for="cat_id">Danh mục Cha <span class="text-danger">*</span></label>
        ...
        <div class="form-group d-none" id="child_cat_div">
          <label for="child_cat_id">Dang mục phụ</label>
        ...
        <div class="form-group">
          ...
          <input id="price" type="number" name="price" placeholder="Nhập giá tiền"  value="{{old('price')}}" class="form-control">
          @error('price')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
