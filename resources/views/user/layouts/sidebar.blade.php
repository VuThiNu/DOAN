...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    @endif
    @if($userRole == 'admin' || $userRole == 'shipping')
    {{-- Shipping --}}
    <li class="nav-item">
    ...
    @endif
    <!--Orders -->
    @if($userRole == 'admin' || $userRole == 'sale_staff' || $userRole == 'shipping')
    <li class="nav-item">
    ...
    @endif
    @if($userRole == 'admin' || $userRole == 'sale_staff')
    <!-- Reviews -->
    <li class="nav-item">
    ...
    <li class="nav-item">
     ...
     <li class="nav-item">
        ...
        <div id="postCategoryCollapse" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Category Options:</h6>
            <a class="collapse-item" href="{{route('post-category.index')}}">Loại sản phẩm</a>
            <a class="collapse-item" href="{{route('post-category.create')}}">Thêm loại sản phẩm</a>
          </div>
        </div>
      </li>
